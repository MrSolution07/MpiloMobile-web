...
//     e.preventDefault();
//     alert("Appointment request submitted! (Demo only)");
...
//         <button
//           type="submit"
//           className="w-full rounded-md bg-red-600 py-2 px-4 text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
//         >
//           Book Appointment
//         </button>
//       </form>

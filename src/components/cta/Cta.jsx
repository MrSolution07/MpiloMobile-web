      ...
      <div className="container">
        <div className="cta-grid">
          <div className="cta-card">
            ...
            <p className="off-shape">
              Mpilo uses artificial intelligence to quickly assess and
          ...
          <div className="cta-card">
            ...
            <p className="on-shape">
              Mobile clinics deliver care directly to communities with limited
              access to traditional facilities.
            </p>
          ...
          <div className="cta-card">
            ...
            <p className="off-shape">
              Book virtual doctor visits and follow-ups right from your device —
              no waiting rooms.
            </p>
          </div>
          ...
          <div className="cta-card">
            ...
            <p className="on-shape">
              Monitor clinic impact and performance with advanced analytics and
              live dashboards.
            </p>
            <div className="card-shape-bottom"></div>
          </div>
          ...
          <div className="cta-card">
            ...
            <p className="off-shape">
              Reduce patient costs by up to 50% while delivering excellent
              medical care and insights.
            </p>
          </div>
        </div>

        <div className="justify-content-center mb-5 row">
          <div className="text-center cta-content-box col-md-10">
            <h2 className="mb-4 sec-title">
        ...
        <div className="justify-content-center mt-5 row">
          <div className="text-center col-md-12">
            <Link to="/services" className="mt-4 rounded-med-2 SkillUplms-btn">
              Explore Services
            </Link>
          </div>
        </div>

        ...
        <div className="row">
          <div className="col-lg-5 col-md-5">
            <div className="hero-content">
              ...
              <p>
                <span style={{ color: "#D7261E" }}>Partnering</span> with the
                private sector to provide comprehensive{" "}
                <span style={{ color: "#D7261E" }}>primary healthcare </span>{" "}
          ...
          <div className="col-lg-7 col-md-7">
            <div className="banner-thumb"></div>
          </div>
        </div>
      </div>
    </section>

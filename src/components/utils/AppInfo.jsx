...
const AppInfo = () => {
  const styles = {
    ...
    phoneMockup: {
      ...
      width: "256px",
      boxShadow:
        "0 20px 40px rgba(0,0,0,0.1), inset 0 2px 4px rgba(255,255,255,0.3)",
      animation: "float 6s ease-in-out infinite",
    },
    phoneMockup2: {
      animationDelay: "-3s",
        ...
        <div style={styles.innerContainer}>
          ...
          <div style={styles.header}>
            ...
            <h2 className="main-title" style={styles.mainTitle}>
              <span style={styles.titleIntro}>Introducing</span>
              <br />
              <span style={styles.titleMain}>Mpilo Mobile App</span>
            </h2>
            <p style={styles.subtitle}>
              Healthcare at your fingertips. Download now and experience the
              ...
              <div style={styles.featuresGrid}>
                <div style={styles.featureCard}>
                  ...
                  <p style={styles.featureText}>
                    Whether you're in a rural village or a busy city, Mpilo
                    delivers care right to your phone with our mobile clinics
                    and doctor-on-demand service.
                  </p>
                </div>
                ...
                <div style={styles.featureCard}>
                  <div style={styles.appIcon}>🏥</div>
                  <h4 style={styles.featureTitle}>
                    From clinic to click - Mpilo brings care closer
                  </h4>
                  <p style={styles.featureText}>
                    Get trusted medical advice, treatment plans, and follow-ups
                ...
                <div style={styles.featureCard}>
                  ...
                  <h4 style={styles.featureTitle}>
                    Real Doctors. Real-Time. Real Easy
                  </h4>
                  <p style={styles.featureText}>
                    ...
                    <div style={styles.loginScreen}>
                      ...
                      <div style={styles.loginForm}>
                        ...
                        <div style={styles.inputField}>
                          ...
                          <div
                            style={{
                              ...styles.inputPlaceholder2,
                              ...styles.inputPlaceholder3,
                            }}
                          />
                        </div>
                    ...
                    <div style={styles.homeScreen}>
                      ...
                      <div style={styles.homeGrid}>
                        <div style={styles.homeCard}>
                          <div
                            style={{ ...styles.homeIcon, ...styles.homeIcon1 }}
                          />
                          <div style={styles.homeCardText} />
                          <div
                            style={{
                              ...styles.homeCardSubtext,
                              ...styles.homeCardSubtext1,
                            }}
                          />
                        </div>
                        <div style={styles.homeCard}>
                          <div
                            style={{ ...styles.homeIcon, ...styles.homeIcon2 }}
                          />
                          <div style={styles.homeCardText} />
                          <div
                            style={{
                              ...styles.homeCardSubtext,
                              ...styles.homeCardSubtext2,
                            }}
                          />
                        </div>
                        <div style={styles.homeCard}>
                      ...
                      <div style={styles.homeList}>
                        <div style={styles.homeListItem}>
                          <div
                            style={{ ...styles.listIcon, ...styles.listIcon1 }}
                          />
                        ...
                        <div style={styles.homeListItem}>
                          <div
                            style={{ ...styles.listIcon, ...styles.listIcon2 }}
                          />
                          <div style={styles.listContent}>
                            <div style={styles.listText} />
                            <div

...
function Footer({ getStart }) {
  return (
    <footer
      className={`footer-1 ${
        !getStart && "pd-top-90"
      } bg-gray-900 text-white px-6 py-10 shadow-lg rounded-t-3xl`}
    >
      <div className="max-w-7xl mx-auto space-y-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div>
            ...
            <div className="flex gap-4 mt-4">
              <Link
                to="https://www.facebook.com/MpiloMobile"
                className="text-gray-900 hover:text-[#508de1]"
              >
                <FaFacebookF size={16} />
              </Link>
              <Link to="#" className="text-gray-900 hover:text-[#508de1]">
                <FaXTwitter size={16} />
              </Link>
              <Link
                to="https://www.instagram.com/mpilo_mobile/"
                className="text-gray-900 hover:text-[#508de1]"
              >
                <FaInstagram size={16} />
              </Link>
        ...
        <div className="text-center border-t border-gray-700 pt-2 pb-4">
          <p className="text-xs text-gray-400">
            ...
            <span className="text-[#508de1]">Major Tech</span>
          </p>
        </div>
      </div>
    </footer>

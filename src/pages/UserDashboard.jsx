...
function PatientDashboard() {
  ...
  const recentActivity = [
    {
      date: "July 25",
      action: "Consultation completed with Dr. Sarah Johnson",
      type: "completed",
    },
    {
      date: "July 23",
      action: "Prescription refilled - Vitamin D supplements",
      type: "prescription",
    },
    {
      date: "July 20",
      action: "Lab results uploaded - Blood work",
      type: "results",
    },
    {
      date: "July 18",
      action: "Appointment scheduled with Dr. Michael Chen",
      type: "scheduled",
    },
  ];
                ...
                {upcomingAppointments[0] && (
                  <div className="border border-gray-200 rounded-lg p-4">
                    ...
                    <div className="flex items-center text-sm text-gray-600 mb-3">
                      {upcomingAppointments[0].type === "Video Call" && (
                        <FaVideo className="h-4 w-4 mr-2" />
                      )}
                      {upcomingAppointments[0].type === "Phone Call" && (
                        <FaPhone className="h-4 w-4 mr-2" />
                      )}
                      {upcomingAppointments[0].type === "In-Person" && (
                  ...
                  {[
                    {
                      ...
                      date: "July 20, 2025",
                      status: "Normal",
                      file: "CBC_July2025.pdf",
                    },
                    {
                      test: "Lipid Panel",
                      date: "June 10, 2025",
                      status: "Normal",
                      file: "Lipid_June2025.pdf",
                    },
                    {
                      test: "Thyroid Function",
                      date: "May 15, 2025",
                      status: "Normal",
                      file: "Thyroid_May2025.pdf",
                    },
                  ].map((result, index) => (
                    <div
                      key={index}

...
/**
 * Gets all doctors for admin to message
...
export const getAllDoctors = async () => {
  try {
    const { data, error } = await supabase
      .from('doctors')
      .select('id, user_id, first_name, last_name, email, specialization, profile_image_url')
...
/**
 * Gets admin user for doctors to message
...
/**
 * Gets patients for a doctor to message
